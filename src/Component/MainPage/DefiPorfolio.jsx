            ...
            <div className="RelatedPortfolioSlider-main-div">
                <div className="RelatedPortfolioSlider-div">
                    <Slider {...settings}>
                        <div>
                            <div className="PrjctExmplsImg">
                                <img
                                    ...
                                    src="./images/DefisliderPortfolio-1.jpg"
                                    alt="Game Portfolio1"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-2.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-3.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-4.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/DefisliderPortfolio-5.jpg"
