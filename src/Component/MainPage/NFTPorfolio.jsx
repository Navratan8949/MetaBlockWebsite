            ...
            <div className="RelatedPortfolioSlider-main-div">
                <div className="RelatedPortfolioSlider-div">
                    <Slider {...settings}>
                        <div>
                            <div className="PrjctExmplsImg">
                                <img
                                    ...
                                    src="./images/Websitesliderportfolio-1.jpg"
                                    alt="Game Portfolio1"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal"
                                    src="./images/Websitesliderportfolio-2.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-3.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-4.jpg"
                        ...
                        <div>
                            <div className="PrjctExmplsImg">
                                <img data-toggle="modal" data-target="#portfolio_modal" src="./images/Websitesliderportfolio-5.jpg"
