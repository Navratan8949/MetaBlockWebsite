                                    ...
                                    <div className="col-lg-7 col-12">
                                        <div className="popup-contact-form">
                                            ...
                                            <form className="fitoutform-1" id="popup_contact_form_home_new" method="post">
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                        <input type='tel' name="mobile" className="form-control" placeholder='Your Phone Number' />
                                ...
                                <div className="contact_info">
                                    ...
                                    <div className="s-info">
                                        <div className="contact-info top-info">
                                            <div className="phone-info">
                                                <a href="" target="_blank"><i className="fab fa-whatsapp" aria-hidden="true" /> +91
                                                    8058465484</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="s-info">
                                        <div className="contact-info">
                                            <div className="phone-info">
                                                <a href="" target="_blank"> <i className="fab fa-telegram" /> MetaBlock Technologies</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="s-info">
                                        <div className="contact-info">
                                            <div className="phone-info">
                                                <a href="https://join.skype.com/invite/lAF0IYo03Kfu" target="_blank"> <i className="fab fa-skype" /> MetaBlock Technology </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="s-info">
                                    ...
                                    <div className="s-info">
                                        <div className="contact-info">
                                            <div className="phone-info">
                                                <a href="" target="_blank"> <i className="fa fa-envelope" /> MetaBlockTechnology.com</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="c-social">
                                        ...
                                        <ul >
                                            <li><a href="" class="facebook" target="_blank"><i class="fab fa-facebook"></i></a></li>
                                            {/* <li><a href="" class="twitter" target="_blank"><i class="fab fa-twitter"></i></a></li> */}
                                            <li><a href="" class="linkedin" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                                            <li><a href="" class="youtube" target="_blank"><i class="fab fa-youtube"></i></a></li>
                                            {/* <li><a href="" class="pinterest" target="_blank"><i class="fab fa-pinterest"></i></a></li> */}
