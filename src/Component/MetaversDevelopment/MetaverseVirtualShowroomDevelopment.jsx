          ...
          <div className="container-fluid cus_container">
            <div className="row align-items-center justify-content-center">
              <div className="col-lg-7 col-12 p-0 nft_top">
                <img src="./SGimage/6594175.jpg" alt="Metaverse-Game-Development-Company" title="Metaverse Game Development Company" className="banner_img img-fluid" />
              </div>
            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-12 col-12">
                ...
                <div className="why_do_box">
                  <h2 className="title">Why is MetaBlock necessary for developing Metaverse Virtual Showroom?</h2>
