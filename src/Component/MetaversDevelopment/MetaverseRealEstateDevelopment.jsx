            ...
            <main id="metaverse_event_platform_main">
                        ...
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-12 col-12">
                                ...
                                <div className="virtual_content_sec">
                                    <h2 className="title">Metaverse Real Estate Development</h2>
                    ...
                    <div className="container">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-6 col-12 order-1 order-lg-2 pl-lg-0">
                                <div>
                                    <h2 className="title">Metaverse Real Estate Development Company</h2>
                ...
                <section className="metaverse_event_platform_solut">
                    <div className="container-fluid">
                        <h2 className="title">Our Metaverse Real Estate Development Solutions</h2>
                ...
                <section className="metaverse_event_platform_features">
                    <div className="container">
                        <h2 className="title">Characteristics Of The Metaverse Real Estate</h2>
                ...
                <section className="metaverse_event_platform_benefits">
                    <div className="container">
                        <h2 className="title">Benefits Of Metaverse Real Estate</h2>
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-lg-9 col-12">
                                <h2 className="title">Why Should the Real Estate Industry Use Metaverse?
                                </h2>
                    ...
                    <div className="container">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-7 col-12">
                                <div>
                                    <h2 className="title-10">Why Use MetaBlock To Develop A Real Estate For The Metaverse?
                                    </h2>
