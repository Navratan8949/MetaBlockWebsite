            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath1">
                  <div className="img_sec">
                    <img src="./images/folder.png" alt="Opportunities for the economy" title="Opportunities for the economy" className="sprite_icons lazyload" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  <div className="img_sec">
                    <img src="./images/game (2).png" alt="Immersive gameplay" title="Immersive gameplay" className="sprite_icons lazyload" style={{ objectPosition: '-99px 0px' }} />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath2">
                  <div className="img_sec">
                    <img src="./images/commuication.png" alt="Social interaction" title="Social interaction" className="sprite_icons lazyload" style={{ objectPosition: '-225px 0px' }} />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath1">
                  <div className="img_sec">
                    <img src="./images/idea (1).png" alt="Creative expression" title="Creative expression" className="sprite_icons lazyload" style={{ objectPosition: '-345px 0px' }} />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  <div className="img_sec">
                    <img src="./images/new-product.png" alt="New ideas" title="New ideas" className="sprite_icons lazyload" style={{ objectPosition: '-448px 0px' }} />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath2">
                  <div className="img_sec">
                    <img src="./images/remote-access.png" alt="Accessible" title="Accessible" className="sprite_icons lazyload" style={{ objectPosition: '-549px 0px' }} />
                  </div>
