    ...
    <>
      <main id="metaverse_game_main">
          ...
          <div className="container-fluid cus_container">
            <div className="row align-items-center justify-content-center">
              <div className="col-lg-7 col-12 p-0 nft_top">
                <img src="./SGimage/3avatar_top.jpg" alt="Metaverse-Game-Development-Company" title="Metaverse Game Development Company" className="banner_img img-fluid" />
              </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 col-12">
                <img src="./SGimage/metavarse game development-2 (1)-min.jpg" alt="Metaverse Game Development" title="Metaverse Game Development" className="img-fluid lazyload metav_game_dev_img" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-12 col-12 nft_top">
                <img src="./SGimage/metaverse game development-1 (1)-min.jpg" alt="Metaverse Game Development" title="Metaverse Game Development" className="img-fluid lazyload" />
              </div>
              <div className="col-lg-12 col-12">
                <h2 className="title">What is Metaverse Avatar?</h2>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-10 col-12 metaverse_game_comp_cardsec">
                <div id="metaverse_game_comp_card">
                  <h2 className="title-14">Metaverse Avatar Development company</h2>
        ...
        <section className="metaverse_game_services">
          <div className="container">
            <h2 className="title text-center">Our Metaverse Avatar development services</h2>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                ...
                <div className="service_box">
                  ...
                  <h3 className="sub_title">Play to Earn Metaverse Avatar Development</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                ...
                <div className="service_box">
                  ...
                  <h3 className="sub_title">Personalized Development of Metaverse Avatar</h3>
                  <p className="sub_contents">We create the game from your distinct concepts, customizing each and every element to fit your vision. Our team of professionals will create a unique gaming experience that appeals to your audience, complete with fascinating tales and captivating gameplay mechanics.
                  </p>
                </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                ...
                <div className="service_box">
                  ...
                  <h3 className="sub_title">DApps for gaming</h3>
        ...
        <section className="metaverse_game_benefits">
          <div className="container">
            <h2 className="title">Benefits of the Metaverse Avatar for Business </h2>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  ...
                  <h3 className="sub_title">Fascinating Avatar</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box clippath1">
                  ...
                  <h3 className="sub_title">Artistic manifestation</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="benefits_box cp_center">
                  ...
                  <h3 className="sub_title">Novel concepts</h3>
          ...
          <div className="container-fluid">
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <h2 className="title">Development of a Metaverse Avatar business model</h2>
        ...
        <section className="metaverse_game_process">
          <div className="container">
            ...
            <h2 className="title">Development Process For Metaverse Avatar</h2>
        ...
        <section className="metaverse_game_clone">
          <div className="container">
            <h2 className="title">List Metaverse Avatar Clone Scripts</h2>
            <div className="row align-items-center">
        ...
        <section className="metaverse_game_category">
          <div className="container">
            <h2 className="title">Various Metaverse Avatar categories that we create</h2>
        ...
        <section className="metaverse_game_industry">
          <div className="container">
            <h2 className="title">Examining Services for Metaverse Avatar Development for Different Industries</h2>
        ...
        <section className="metaverse_game_hire">
          <div className="container-fluid">
            <h2 className="title">Employ Developers for Metaverse Avatar</h2>
              ...
              <div className="col-lg-6 col-md-12 col-12 pl-lg-5">
                <div className="pl-lg-5">
                  ...
                  <div className="metaverse_game_btn_sec">
                    <button toggle="modal" target="#popup_form_modal" className="btn BtnPrimry TlkBtn metaverse_game_btn">
                    <Link to="/ContectUsForm">   <span alt="enquiry" loading="eager" className="img-fluid lazyload mr-2 lazyload" >Get A Live Demo</span></Link>
            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-12 col-12">
                ...
                <div className="why_do_box">
                  <h2 className="title">Why is MetaBlock necessary for developing Metaverse Avatar?</h2>
                  ...
                  <h3 className="sub_title">The following are our possible gains in the creation of a metaverse avatar:</h3>
                  <div className="row justify-content-center">
