    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide>
                    <img src="./images/realestateslider-1.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/realestateslider-2.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/realestateslider-3.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/realestateslider-4.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/realestateslider-5.jpg" />
                </SwiperSlide>
            </Swiper>
        </>
    );
