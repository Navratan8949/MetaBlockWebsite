    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide>
                    <img src="./images/Eventslider-1.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/Eventslider-2.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/Eventslider-3.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/Eventslider-4.jpg" />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="./images/Eventslider-5.jpg" />
                </SwiperSlide>
