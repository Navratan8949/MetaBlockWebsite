  ...
  return (
    <>
      <main className="blog_new_main">
        ...
        <section className="section core-value bg-tertiary position-relative  stechnologies">
        ...
        {/* <section>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >
                        <h1 style={{ fontSize: "50px" }} className="display-4  glow-text c-head text-white fw-bold g-text g-text-h">Why Choose Us</h1>
                    </div>
                    <div className="chooseus-in" >
                        <div className="award-1 col-lg-4" style={{}}>
                            <div className="text-start" style={{ color: "white", borderRadius: "10px", padding: "15px" }}>
                                <h1 className="fs-4 year">YEARS of Work Exp.</h1>
                                <h1 className="text-warning" style={{ fontSize: "20px" }}>10+</h1>
                                <p style={{ fontSize: "16px" }}>substantial experience in delivering IT solutions &amp; services.</p>
                            </div>
                        </div>
