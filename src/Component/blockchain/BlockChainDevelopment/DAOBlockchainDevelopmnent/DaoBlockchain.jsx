          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-12">
                <h1 className="title-1"> <span className="cus_title-1">Dao </span><br /> <span className="grad_text"> Blockchain Development</span> Organization </h1>
                <h3 className="contents">MetaBlock offers all of the assistance needed to create a public blockchain for a &amp; distributed network that is open and transparent, as well as the complete solution needed to create a private blockchain for a network that is acceptable and secures business data.</h3>
              ...
              <div className="col-lg-7">
                <div className="bs_d_c_bg">
                  ...
                  <div>
                    ...
                    <p className="section_heading">Private blockchains are networks that are controlled by a single company or group and restrict blockchain access to specific users. Data on a private blockchain can be shared with particular people without being made public.</p>
                    <p className="section_heading">Metablock Technologies has extensive expertise developing blockchain applications for several sectors worldwide. With blockchain experience, we are experts at creating public or private blockchains based on your company's needs in order to efficiently simplify your business processes.</p>
                    <div className="blk_dev_bnr_btn_sec">
        ...
        <section className="mid_section">
          <div className="container">
            <div className="section-heading text-center">
              <h3>Examining Facts Of <b>Public And Private </b>Blockchain</h3>
            ...
            <div className="row mt-5">
              ...
              <div className="col-sm-3">
                <div className="work_with_box">
                  ...
                  <p className="normal_text">Since the public blockchain is accessible to all members of the network, it lacks privacy and can be used for widespread advertising. However, because private blockchain data is exchanged with specified individuals, it offers greater anonymity.</p>
                </div>
              </div>
              <div className="col-sm-3">
                <div className="work_with_box">
              ...
              <div className="col-sm-3">
                <div className="work_with_box">
                  ...
                  <p className="normal_text">A public blockchain network permits anybody to join and become a member, whereas a private blockchain network limits access to network membership to certain persons.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="alg_mac">
          <div className="container">
            <div className="section-heading text-center">
              ...
              <p className="para_title-1">Anybody who can solve the cryptographic method can join your blockchain network and see or share data, making it a public blockchain. Companies that use public blockchains stand to gain from the following:</p>
              <div className="why_round"> </div>
            </div>
            <div className="row mt-5">
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-7 col-12 pr-lg-0">
                ...
                <div className="blk_dev_bnr_btn_sec">
                <Link to="/ContectUsForm">  <span target="_blank" className="blk_dev_bnr_btn">View Live Demo</span></Link>
                </div>
              </div>
