          ...
          <div className="container">
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-5">
                <div className="">
                  <img src="./images/Astrologysliderpic-1.png" alt="" />
                  {/* <div className="video-container" id="video-container-next">
                    <div className="videoCoverImage">
                      <div onclick="thevid=document.getElementById('thevideo_b'); thevid.style.display='block'; this.style.display='none'">
                        <img className="thumb img-fluid lazyload" loading="eager" alt="" style={{ cursor: 'pointer' }} src="https://lexica.art/prompt/902f2dbd-473f-47cc-a657-d3ec742eeff5" />
                      </div>
              ...
              <div className="col-sm-3">
                <div className="work_with_box">
                  <div className="inr_img">
                    <img src="./images/settings.png" className="" alt="Decentralization" title="Decentralization" />
                  </div>
                  {/* <div className="head_sec d-flex justify-center align-center flex-column">
                    <img width={'50px'} src='./images/settings.png' alt="A self" title="A self" />
                  </div>
