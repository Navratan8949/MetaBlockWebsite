    ...
    <div>
      ...
      <main id="token_dev_main">
            ...
            <div className="row align-items-center justify-content-center">
              ...
              <div className="col-lg-6 col-12 order-1 order-lg-2">
                <div className="banner_cont_sec">
                  <h1 className="title"><span className="bnr_bld_title">Binanace Intelligent  </span> <br /> Chain Tokan Creation </h1>
        ...
        <section className="token_dev_process">
          <div className="container">
            <h2 className="title">How to Create Your Own Token for Cryptocurrency</h2>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    <span className="num_sec">01</span>
                    <h3 className="sub_title">Creation of Smart Contracts</h3>
                  </div>
                  <p className="sub_contents">Next, the development team designs the token's smart contract, either by implementing the chosen token standard (such ERC-20, ERC-721, or BEP-20) or, if necessary, by developing a custom smart contract.</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    ...
                    <h3 className="sub_title">Configuring the Token Identity</h3>
                  </div>
                  <p className="sub_contents">Token identity establishing, which includes user-specified decisions including selecting the token's name, symbol, and capabilities in order to build a distinct and identifiable token, is a crucial step in the token production process.</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    ...
                    <h3 className="sub_title">Composing Whitepapers</h3>
                  </div>
                  <p className="sub_contents">Our gifted content writers expertly arrange whitepapers in accordance with your business's specifications, presenting the objectives, technology, and project vision in a clear and captivating manner.</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    ...
                    <h3 className="sub_title">Take Action to Discover</h3>
                  </div>
                  <p className="sub_contents">The company and the client collaborate to understand use cases, corporate objectives, and specific needs.</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
                  ...
                  <p className="sub_contents">Token development requires selecting the right blockchain architecture because tokens are blockchain-based smart contracts.</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    ...
                    <h3 className="sub_title">Release of Tokens</h3>
                  </div>
                  <p className="sub_contents">We construct your tokens with a commitment to several criteria, ensuring the greatest level of quality and compliance.</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-12">
                <div className="process_box">
                  <div className="head_sec">
                    ...
                    <h3 className="sub_title">An ICO's launch</h3>
                  </div>
                  <p className="sub_contents">Your ICO and tokens are positioned for a successful debut in the cryptocurrency market.</p>
                </div>
              </div>
            </div>
          </div>
