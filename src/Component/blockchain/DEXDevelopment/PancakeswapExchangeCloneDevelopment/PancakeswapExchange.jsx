  ...
  return (
    <div>
      <main id="white_label_crypto_main">
        ...
        >
          <div className="container">
            <h2 className="title-10">Based on security measures, our solutions
</h2>
            <p className="contents">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="types_box">
                  <h3 className="sub_title-10">Private key approach
</h3>
                  <p className="sub_content">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="types_box">
                  <h3 className="sub_title-10">2FA as well as anti-phishing protocols</h3>
                  <p className="sub_content">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="types_box">
                  <div className="sub_title-10">Support and recuperation</div>
                  <p className="sub_content">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="types_box">
                  <h3 className="sub_title-10">Wallet division
</h3>
                  <p className="sub_content">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="types_box">
                  <h3 className="sub_title-10">Warm and chilly pocketbooks
</h3>
                  <p className="sub_content">
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  ...
                  />
                  <h3 className="sub_title-10">Development of Hybrid Exchanges
 </h3>
                  <p className="sub_content">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  ...
                  />
                  <h3 className="sub_title-10">Development of P2P Exchanges</h3>
                  <p className="sub_content">
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  ...
                  />
                  <h3 className="sub_title-10">Development of Escrow Exchange</h3>
                  <p className="sub_content">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-12">
                <div className="types_box">
                  ...
                  />
                  <div className="sub_title-10">Development of Futures Exchanges</div>
                  <p className="sub_content">
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-5 col-12">
                <h2 className="title-10">Modules for White Label Crypto Exchanges</h2>
                <p className="contents">
                  ...
                  <div className="row row_justify process_line">
                    <div className="col-lg-2 col-12">
                      <div className="process_list">
                        ...
                        <p className="sub_title-10">Analysis of Requirements
</p>
                        <p className="sub_content">
                    ...
                    <div className="col-lg-2 col-12">
                      <div className="process_list">
                        ...
                        <p className="sub_title-10">Design Procedure
</p>
                        <p className="sub_content">
                    ...
                    <div className="col-lg-2 col-12">
                      <div className="process_list">
                        ...
                        <p className="sub_title-10">Included Attribute
</p>
                        <p className="sub_content">
                    ...
                    <div className="col-lg-2 col-12">
                      <div className="process_list">
                        ...
                        <p className="sub_title-10">Verification of Security
</p>
                        <p className="sub_content">
                    ...
                    <div className="col-lg-2 col-12">
                      <div className="process_list">
                        ...
                        <p className="sub_title-10">Gateway for payments</p>
                        <p className="sub_content">
