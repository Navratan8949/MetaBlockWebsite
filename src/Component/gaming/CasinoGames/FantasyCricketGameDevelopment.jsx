          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-lg-5 p-lg-0">
                <img
                  style={{ width: "200%", paddingLeft: "100px" }}
              ...
              <div className="Admin-control-inner-container">
                <div className="a-card card-discover card1 col-md-3">
                  ...
                  <p className="card__description">
                    Play Ludo using your skills and win to earn real cash. Use
                    your ludo expertise to earn real money instead of just using
                    it to pass time.
                  </p>
                </div>
                <div className="a-card card-discover card1 col-md-3">
                  <div className="card-icon-title-wrapper">
                    <div className="card__icon pb-1">
                      <div className="icon__wrapper">
                        <img
                          src="./images/Play-Online-with-real-money.png"
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <div className="a-card card-discover col-md-3">
                  <div className="card-icon-title-wrapper">
                    <div className="card__icon pb-1">
                      <div className="icon__wrapper ">
                        <img
                          src="./images/Quick-Deposit-&-Withdraw-money.png"
                          alt
                        />
                      </div>
                    </div>
                ...
                <div className="a-card card-discover col-md-3">
                  <div className="card-icon-title-wrapper">
                    <div className="card__icon pb-1">
                      <div className="icon__wrapper">
                        <img
                          src="./images/Deposit-&-withdraw-history.png"
                          alt
                        />
                      </div>
                    </div>
          ...
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-lg-3 col-12">
                <h2 className="title">
                  <span style={{ color: "#FFA024" }}>MetaBlock</span> Your go-to
                  game development company. Find out why
                </h2>
                <p className="contents">
