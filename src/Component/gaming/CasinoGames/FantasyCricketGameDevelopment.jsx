...
const FantasyCricketGameDevelopment = () => {
            ...
            <main id="game_dev_comp_main">
                    ...
                    <div className="row">
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                                <h1 className="display-5 txt-center-m glow-text lh-1 mb-3 text-white fw-bold g-text">Fantasy App<span style={{ fontWeight: 'lighter' }}> Development <span>
                                </span></span></h1>
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                        ...
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/fantasygame1.png" alt />
                        </div>
                    </div>
                </section>
  ...
  <div class="bg-filter-dark"></div> */}
                    <div className="row">
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/fantasygame2.png" alt />
                        </div>
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                                <h1 className="display-5 glow-text lh-1 mb-3 text-white fw-bold g-text">Fantasy App Development Services
                                </h1>
                                {/* <h2 class="text-white display-1 lh-1 mb-4 ">
              WE MAKE DREAMS <br> COME TO LIFE
          </h2> */}
