...
const BaccaratGameDevelopment = () => {
                    ...
                    <div className="row">
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                                <h1 className="display-5 txt-center-m glow-text lh-1 mb-3 text-white fw-bold g-text">Baccarat Game<span style={{ fontWeight: 'lighter' }}> Development <span>
                                </span></span></h1>
                        ...
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/casino-game-development-in-india.png" alt />
                        </div>
                    </div>
                </section>
  ...
  <div class="bg-filter-dark"></div> */}
                    <div className="row">
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/casino-game-development-in-india-2.png" alt />
                        </div>
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                            ...
                            <div className="Admin-control-inner-container">
                                <div className="a-card card-discover card1 col-md-3">
                                    ...
                                    <p className="card__description">
                                        Play Baccarat using your skills and win to earn real cash. Use your Baccarat expertise to earn real money instead of just using it to pass time.
                                    </p>
                                </div>
                                <div className="a-card card-discover card1 col-md-3">
                                    <div className="card-icon-title-wrapper">
