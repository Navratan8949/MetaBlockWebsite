            ...
            <main id="game_dev_comp_main">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                        ...
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/dragon-tiger-game-development-in-india.png" alt />
                        </div>
                    </div>
                </section>
                            ...
                            <div className="Admin-control-inner-container">
                                <div className="a-card card-discover card1 col-md-3">
                                    ...
                                    <p className="card__description">
                                        Play Dragon Tiger using your skills and win to earn real cash. Use your Dragon Tiger expertise to earn real money instead of just using it to pass time.
                                    </p>
                                </div>
                                <div className="a-card card-discover card1 col-md-3">
                                    <div className="card-icon-title-wrapper">
