...
const TournamentDevelopment = () => {
                    ...
                    <div className="row">
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                                <h1 className="display-5 txt-center-m glow-text lh-1 mb-3 text-white fw-bold g-text">tournament<span style={{ fontWeight: 'lighter' }}> Development <span>
                                </span></span></h1>
                                {/* <h2 class="text-white display-1 lh-1 mb-4 ">
              WE MAKE DREAMS <br> COME TO LIFE
          </h2> */}
                                <h3 className=" mb-4 mt-4 txt-center-m">
                                    Top Rated tournament development Developer
                                </h3>
                                <p style={{ color: "white" }} className=" fw-normal mb-4 txt-center-m">
                                    MetaBlock is a leading tournament development company. Our team of expert tournament development developers excels in creating visually appealing, user-friendly, and immersive tournament development. We incorporate a plethora of advanced features to enhance the gaming experience and ensure that players enjoy the best possible gameplay. Our aim is to deliver top-quality Rummy games that meet the expectations of players.
                        ...
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/tournamentdevelopment.png" alt />
                        </div>
                    </div>
                </section>
  ...
  <div class="bg-filter-dark"></div> */}
                    <div className="row">
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/tournamentdevelopment1.png" alt />
                        </div>
                        <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
                            <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                                ...
                                <p className=" fw-normal text-white mb-4 ">
                                    MetaBlock Technologies is a leading Roulette Game app development company. Our efficient game developers have years of experience in developing Rummy games and with their expertise, they can develop games that will definitely make you remember your childhood. Roulette is a game in which we hold a successful track record in the market. We have again and again proved with our effective solutions that we are the #1 Rummy Game Development company.
                        ...
                        <div className="row align-items-center justify-content-center">
                            <div className="col-lg-6 col-12">
                                <div className="banner_sec">
                                    <h1 className="title">
                                        <span className="bnr_clr_title">tournament development </span>{" "}
                                        <br /> Development
                                    </h1>
                                    <p className="contents">
                                        MetaBlock is a leading tournament development development company. Our experienced team of tournament development developers specialized in creating visually captivating and user-friendly tournament developments. We incorporate advanced features that enhance the overall gaming experience, catering to Ludo enthusiasts worldwide. Our goal is to deliver an unparalleled Ludo gaming experience that captures the interest and enjoyment of players globally.
                                    </p>
                    ...
                    <div className="container-fluid">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-7 cus_col">
                                <h2 className="title">
                                    tournament development Development on Prime Platforms
                                </h2>
                                <div className="row">
                ...
                <section className="game_dev_comp_techstack">
                    <div className="container">
                        ...
                        <div className="Admin-control-main-container">
                            <h4 >Online tournament development Features</h4>
