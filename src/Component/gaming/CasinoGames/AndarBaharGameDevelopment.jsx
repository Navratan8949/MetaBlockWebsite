            ...
            <main id="game_dev_comp_main">
              ...
              WE MAKE DREAMS <br> COME TO LIFE
                        ...
                        <div className="col-lg-6 ps-0">
                            <img className="cta-content-img" src="./images/multi-gaming-app-development-in-india.png" alt />
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row align-items-center justify-content-center">
                            <div className="col-lg-6 col-12">
                                <div className="banner_sec">
                                    <h1 className="title">
                                        <span className="bnr_clr_title">AndarBahar Game </span>{" "}
                                        <br /> Development
                                    </h1>
                                    <p className="contents">
                                        MetaBlock is a leading AndarBahar Game development company. Our experienced team of AndarBahar game developers specialized in creating visually captivating and user-friendly AndarBahar games. We incorporate advanced features that enhance the overall gaming experience, catering to AndarBahar enthusiasts worldwide. Our goal is to deliver an unparalleled AndarBahar gaming experience that captures the interest and enjoyment of players globally.
                                    </p>
                    ...
                    <div className="container-fluid">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-7 cus_col">
                                <h2 className="title">
                                    AndarBahar Game Development on Prime Platforms
                                </h2>
                                <div className="row">
                ...
                <section className="game_dev_comp_techstack">
                    <div className="container">
                        ...
                        <div className="Admin-control-main-container">
                            <h4 >Online AndarBahar Game Features</h4>
                            <div className="Admin-control-inner-container">
                                <div className="a-card card-discover card1 col-md-3">
                                    ...
                                    <p className="card__description">
                                        Play AndarBahar using your skills and win to earn real cash. Use your AndarBahar expertise to earn real money instead of just using it to pass time.
                                    </p>
                                </div>
                                <div className="a-card card-discover card1 col-md-3">
                                    <div className="card-icon-title-wrapper">
...
export default AndarBaharGameDevelopment;