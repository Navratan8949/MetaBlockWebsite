...
const RummyGameDevelopment = () => {
          ...
          <div className="row">
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                <h1 className="display-5 txt-center-m glow-text lh-1 mb-3 text-white fw-bold g-text">Rummy Game<span style={{ fontWeight: 'lighter' }}> Development <span>
                </span></span></h1>
            ...
            <div className="col-lg-6 ps-0">
              <img className="cta-content-img" src="./images/rummygame1.png" alt />
            </div>
          </div>
        </section>
  ...
  <div class="bg-filter-dark"></div> */}
          <div className="row">
            <div className="col-lg-6 ps-0">
              <img className="cta-content-img" src="./images/rummygame2.png" alt />
            </div>
            <div className="cta-content ps-5 col-lg-6 d-flex align-items-center overflow-hidden">
              <div className="container px-5 ms-3 row gx-5 py-5 align-items-center">
                <h1 className="display-5 glow-text lh-1 mb-3 text-white fw-bold g-text">Rummy Game Development Services
                </h1>
                {/* <h2 class="text-white display-1 lh-1 mb-4 ">
              WE MAKE DREAMS <br> COME TO LIFE
          </h2> */}
                        ...
                        <div className="row align-items-center justify-content-center">
                            <div className="col-lg-6 col-12">
                                <div className="banner_sec">
                                    <h1 className="title">
                                        <span className="bnr_clr_title">Rummy GameGame </span>{" "}
                                        <br /> Development
                                    </h1>
                                    <p className="contents">
                                        MetaBlock is a leading Rummy GameGame development company. Our experienced team of Rummy Gamegame developers specialized in creating visually captivating and user-friendly Rummy Gamegames. We incorporate advanced features that enhance the overall gaming experience, catering to Rummy Gameenthusiasts worldwide. Our goal is to deliver an unparalleled Rummy Gamegaming experience that captures the interest and enjoyment of players globally.
                                    </p>
          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7 cus_col">
                <h2 className="title">
                  Rummy GameGame Development on Prime Platforms
                </h2>
                <div className="row">
        ...
        <section className="game_dev_comp_techstack">
          <div className="container">
            ...
            <div className="Admin-control-main-container">
              <h4 >Online Rummy GameGame Features</h4>
              <div className="Admin-control-inner-container">
                <div className="a-card card-discover card1 col-md-3">
                  ...
                  <p className="card__description">
                    Play Rummy Gameusing your skills and win to earn real cash. Use your Rummy Gameexpertise to earn real money instead of just using it to pass time.
                  </p>
                </div>
                <div className="a-card card-discover card1 col-md-3">
                  <div className="card-icon-title-wrapper">
